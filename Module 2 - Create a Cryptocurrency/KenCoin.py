...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Okumu', amount=10)
...
def connect_node():
    ...
    if nodes is None:
        return "No active node found", 400

    for node in nodes:
        blockchain.add_node(node)

    response = {
        'message': 'All nodes are now connected. The KenCoin Blockchain contains the following nodes:',
